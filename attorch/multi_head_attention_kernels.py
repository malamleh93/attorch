"""
Kernels for multi-headed attention.

This a copy-paste of the official Triton flash attention implementation,
available at https://github.com/triton-lang/kernels/blob/main/kernels/flash_attention.py.
"""
...
class _attention(torch.autograd.Function):
    ...
    def backward(ctx, do):
        ...
        _bwd_kernel[
            (ctx.grid[1], triton.cdiv(seq_len_kv, BLOCK) if sequence_parallel else 1)
        ](
            q,
            k,
            v,
